...
function normalisePageData(data: RawPlayerPageData): PlayerPageData {
  return {
    ...data,
...
export default async function PredictPage({
  ...
  const { data, error } = await supabase.rpc("get_player_prediction_page", {
    target_token: token,
  });
  ...
  const rawPageData = data as RawPlayerPageData | null;
